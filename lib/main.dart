...
class _PortfolioHomePageState extends State<PortfolioHomePage> {
  ...
  final socialLinks = [
    {'label': 'GitHub', 'icon': Icons.code, 'url': 'https://github.com/ashwinikalakani'},
    {
      'label': 'LinkedIn',
      'icon': Icons.business_center,
      'url': 'https://www.linkedin.com/in/ashwini-kalakani-a99589342',
    },
  ];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Hi! I am Ashwini M Kalakani, a BCA student passionate about Flutter app development and UI design. '
                'I enjoy creating simple, user-friendly mobile applications and continuously learning new technologies.',
              ),
